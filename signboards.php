...
?>
    ...
    <div class="container-fluid bnr_con">
        <div class="bnr">
            <img class="responsive" src="images/banners/signages.jpg" alt="">
			<div class="ovrly">
			<p>Choose Best signages</p>
			</div>			
        </div>
        <div class="tit_b">
            <p>signages </p> 
        ...
        <?php
            $id = 7;
            $sql = "SELECT * FROM product_details WHERE category_id=23";
        ...
        <div class="col-lg-4">
            ...
            <img class="card-img-top responsive prd_img" src="uploads/product_images/signboards/<?php echo $row['product_image'] ?>" alt="Card image cap">
            <div class="card-body">
