...
?>
    ...
    <div class="container-fluid bnr_con">
        <div class="bnr">
            <img class="responsive" src="images/banners/stationary.jpg" alt="">
			<div class="ovrly">
			<p>Choose Best stationary here</p>
			</div>			
        </div>
        <div class="tit_b">
            <p>Stationary Kit </p> 
        ...
        <div class="col-lg-4">
            ...
            <img class="card-img-top responsive prd_img" src="uploads/product_images/stationary/<?php echo $row['product_image'] ?>" alt="Card image cap">
            <div class="card-body">
