                    ...
                    <div class="row">
                        ...
                        <div class="card card-small card-post mb-4">
                            <div class="card-body">
                                ...
                                <p>
                                Order status : <span><?php if($row['status']==1){ echo "Confirmed";}else{echo "Pending";} ?></span>
                                </p>
                                <p>
                        ...
                        <div class="col">
                          <form>
                            <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                <label for="feLastName">Phone</label>
                                <input type="text" class="form-control" id="feLastName" placeholder="Last Name" value="<?php echo $row3['mobile'] ?>"> </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Email</label>
                                <input type="email" class="form-control" id="feEmailAddress" value="<?php echo $row['email']; ?>"> </div>
                              
                            </div>
                            <div class="form-group">
                              <label for="feInputAddress">Address</label>
                              <input type="text" class="form-control" id="feInputAddress" placeholder="1234 Main St" value="<?php echo $row3['address'] ?>"> </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                              ...
                              <p>Logo</p>
                                <div class="col-lg-9">
                                    <img class="responsive" src="https://www.flexiprint.in/portfolio/images/projects/printdesigning/My-InvestGuru-1m.jpg" alt="">
                                </div>
                                <div class="col-lg-3">
                                    <p>
                                    <button type="submit" class="btn btn-accent">Download Attachment</button>
                                    </p>
                                </div>
                             </div>
                            </div>
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" name="feDescription" rows="5"><?php echo $row['additional_text']; ?></textarea>
                              </div>
                            </div>
